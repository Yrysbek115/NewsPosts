from .exceptions import (
    ...
    BadRequestException, NotAcceptableException, IntegrityException, PermissionDeniedException,
...
from .responses import (
    ...
    SuccessResponse, ServiceUnavailableExceptionResponse, PermissionExceptionResponse
)
...
EXCEPTION_MAPPER = {
    ...
    ServiceUnavailableException.__name__: ServiceUnavailableExceptionResponse
}
